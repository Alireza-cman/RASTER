...
def RASTERU(x_train,y_train, x_test, y_test,n_features = 10_000):
    parameter = fit(x_train,num_features =n_features)

    x_train_trans_org = transform(x_train, parameter,'ter')
    x_test_trans_org = transform(x_test, parameter,'ter')
